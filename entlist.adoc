...
Example
~~~~~~~
[cols="100 a,38 a,88 a,30 a,200 a"]
|===
5s|name_here
5+|Point, Solid, or Point or Solid
5+|source mod 1, source mod 2,... source mod n
5+|Description of what it does.
|variable1|datatype|[min,max] or [choice 1, choice 2,...choice n] if numeric|default|Description
|variable2|datatype|[min,max] or [choice 1, choice 2,...choice n] if numeric|default|Description
|variablen|datatype|[min,max] or [choice 1, choice 2,...choice n] if numeric|default|Description
|===
